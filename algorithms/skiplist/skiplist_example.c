// skiplist,跳表
// https://github.com/hit9/C-Snip/blob/master/example/skiplist_example.c
// http://zhangtielei.com/posts/blog-redis-skiplist.html
// https://www.cl.cam.ac.uk/teaching/0506/Algorithms/skiplists.pdf

/*
gcc -c skiplist.c -o skiplist.o
gcc -c skiplist_example.c -o skiplist_example.o
gcc out/skiplist_example.o out/skiplist.o  -o out/skiplist_example.out 
*/ 
#include <assert.h>
#include <stdio.h>
#include "skiplist.h"
