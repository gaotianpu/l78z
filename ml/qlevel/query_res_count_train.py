...
tfidf_vect = TfidfVectorizer(
    analyzer='char', decode_error='ignore', ngram_range=(2, 5), max_features=500)
...
dump(tfidf_vect, 'model/TfidfVectorizer.res_count.joblib')
pickle.dump(tfidf_vect, open(
    'model/TfidfVectorizer.res_count.pickle', "wb"))  # , protocol=2
